...
addition_operator= tk.Button(root, text='+', font=('helvetica', 24))
...
empty_one = tk.Button(root, text='', font=('helvetica', 24))
...
empty_two = tk.Button(root, text='', font=('helvetica', 24))
...
all_clear_sign = tk.Button(root, text='AC', font=('helvetica', 24))
