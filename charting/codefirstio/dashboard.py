# credits: https://github.com/codefirstio/tkinter-matplotlib-dashboard/blob/main/dashboard.py
...
label = tk.Label(side_frame, text='Dashboard', bg='#4C2A85', fg='#FFFFFF', font=25)
